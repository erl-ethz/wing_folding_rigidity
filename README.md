...
This repository contains the MatLab code to derive Eqn. 2 in *Girardi, Luca, et al. "Biodegradable Gliding Paper Flyers Fabricated Through Inkjet Printing." 2024 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS). IEEE, 2024*, [doi.org/10.1109/IROS58592.2024.10801580](doi.org/10.1109/IROS58592.2024.10801580), to validate the stiffening ratio equation with finite element analysis. 
